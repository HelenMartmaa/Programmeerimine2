...
{
    public class DeleteDoctorsCommandHandler : IRequestHandler<DeleteDoctorsCommand, OperationResult>
    {
        private readonly ApplicationDbContext _dbContext;

        public DeleteDoctorsCommandHandler(ApplicationDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<OperationResult> Handle(DeleteDoctorsCommand request, CancellationToken cancellationToken)
        {
